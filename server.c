...
int main(int argc, char *argv[]) {
    ...
    pthread_create(&threadID, NULL, sendUDPtoSnds, &broadcastSockInfo); //Запускаем потоки широковещательной рассылки
    ...
    pthread_create(&threadID, NULL, listener, &socketInfo); //Запускаем поток для слушателя получателей
